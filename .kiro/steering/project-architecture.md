...
- `/deep-scan-v4` — Multi-page site audit (10 + 1/page). API: `/api/analyze-deep-v3`
- `/battle-mode-v3` — Competitor Duel, head-to-head comparison (20 credits). API: `/api/battle-v3`
- `/keyword-arena-v3` — Keyword Arena, multi-site scoring (5/site). API: `/api/keyword-arena-v3`
