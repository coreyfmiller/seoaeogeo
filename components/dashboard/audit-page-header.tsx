  ...
  return (
    <div className="mb-6">
      <div className="flex flex-col gap-4">
        ...
        {/* URL + status badges + Site Intelligence — single row */}
        ...
        {/* Site Intelligence + Built With + CWV — single inline row */}
        {hasResults && siteType && (
          <div className="flex flex-wrap items-center gap-3">
            {/* Site Intelligence pill */}
            <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg border border-[#842ce0]/30 bg-[#842ce0]/5 shrink-0">
