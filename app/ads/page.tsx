...
function AdFrame({ ratio, children, id }: { ratio: '4:3' | '1:1' | '16:9' | '4:5'; children: React.ReactNode; id: string }) {
  ...
  if (isHidden) {
    return (
      <div className="flex items-center gap-3 opacity-50 py-2 border-b border-white/5 w-fit" style={{ order: isPrioritized ? -1 : 0 }}>
        <button onClick={() => toggleHidden(false)} className="w-6 h-6 flex items-center justify-center rounded bg-white/5 text-white/40 border border-white/10 hover:bg-white/10 hover:text-white transition-colors" title="Restore Ad">
    ...
    <div className="flex flex-col gap-2 transition-all duration-500" style={{ order: isPrioritized ? -1 : 0 }}>
      <div className="flex items-center gap-2">
        <div className="flex items-center gap-1.5 mr-1">
          <button onClick={togglePrioritized} className={`w-6 h-6 flex items-center justify-center rounded transition-colors ${isPrioritized ? 'bg-green-500/20 text-green-400 border border-green-500/50' : 'bg-white/5 text-white/40 border border-white/10 hover:bg-green-500/10 hover:text-green-400 hover:border-green-500/30'}`} title={isPrioritized ? "Unpin Ad" : "Approve & Pin Ad"}>
            <span className="text-xs font-black">✓</span>
          </button>
          <button onClick={() => toggleHidden(true)} className="w-6 h-6 flex items-center justify-center rounded bg-white/5 text-white/40 border border-white/10 hover:bg-red-500/10 hover:text-red-400 hover:border-red-500/30 transition-colors" title="Reject & Hide Ad">
            <span className="text-xs font-black">✕</span>
          </button>
        </div>
      ...
      <div className={`rounded-2xl overflow-hidden border transition-colors duration-300 ${isPrioritized ? 'border-green-500/50 shadow-[0_0_30px_rgba(34,197,94,0.15)]' : 'border-white/10'}`} style={{ aspectRatio: aspectMap[ratio], width: widthMap[ratio] }}>
        {children}
      </div>
    </div>
  )
  ...
  return (
    <main className="h-screen overflow-y-auto bg-[#050508] text-white p-8">
      <div className="max-w-5xl mx-auto flex flex-col gap-12 pb-20">
        ...
        {/* ═══════════════════════════════════════════════════════════════
            DIRECT RESPONSE AD COPY — 10 High-Conversion Text Variations
            Each ad: Disruptive Hook → $79.99 Price Transparency → Mechanical Benefit → No-Friction CTA
            ═══════════════════════════════════════════════════════════════ */}

        <div className="w-full max-w-3xl mx-auto pt-16 pb-8 border-t border-white/10" style={{ order: 100 }}>
          <p className="text-xs font-bold text-[#BC13FE] uppercase tracking-[0.4em] mb-2">Direct Response Copy</p>
          <p className="text-2xl font-black text-white">10 High-Conversion Ad Variations</p>
          <p className="text-sm text-white/40 mt-1">Text-based direct response ads. Every ad leads with $79.99 as a trust signal.</p>
        </div>

        {/* AD 96: The Price Comparison (16:9) */}
        <AdFrame ratio="16:9" id="ad-96-dr-price-comparison">
          <div className="w-full h-full bg-[#050508] relative overflow-hidden flex flex-col justify-center px-16 py-12">
            <div className="absolute top-0 right-0 w-[40%] h-full bg-[radial-gradient(ellipse_at_right,#00e5ff10,transparent_70%)]" />
            <div className="relative z-10 space-y-6 max-w-2xl">
              <p className="text-xs font-bold text-[#00e5ff] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Stop paying $500 a month for legacy SEO tools that can&apos;t even see an AI Overview.
              </p>
              <p className="text-lg text-white/60 leading-relaxed">
                Duelly.ai is <span className="text-[#00e5ff] font-black">$79.99</span>. We don&apos;t have a bloated sales team or expensive office space to fund. You pay for the data and the analysis that actually gets you cited by LLMs.
              </p>
              <p className="text-sm text-white/40 leading-relaxed">
                Get a full GEO (Generative Engine Optimization) report that shows exactly why Perplexity is recommending your competitor instead of you.
              </p>
              <div className="inline-block px-6 py-3 bg-[#00e5ff]/10 border border-[#00e5ff]/30 rounded-xl">
                <p className="text-lg font-black text-[#00e5ff]">Get Your First Audit for $79.99 →</p>
              </div>
            </div>
          </div>
        </AdFrame>

        {/* AD 97: The Anti-Enterprise (4:5) */}
        <AdFrame ratio="4:5" id="ad-97-dr-anti-enterprise">
          <div className="w-full h-full bg-[#0a0a12] relative overflow-hidden flex flex-col justify-center p-10 text-center">
            <div className="absolute inset-0 bg-gradient-to-b from-[#BC13FE]/5 to-transparent" />
            <div className="relative z-10 space-y-6 flex flex-col items-center">
              <p className="text-xs font-bold text-[#BC13FE] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Most AEO tools require a &quot;Demo Call.&quot;<br />
                <span className="text-[#BC13FE]">We just want to show you the data.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed max-w-sm">
                It is <span className="text-[#BC13FE] font-black">$79.99</span>. No &quot;custom quotes&quot; and no surprise upsells. Just professional grade AI Search analysis for serious builders.
              </p>
              <p className="text-sm text-white/40 leading-relaxed max-w-sm">
                Identify the &quot;Information Fragments&quot; on your site that are currently invisible to ChatGPT and Gemini.
              </p>
              <div className="inline-block px-6 py-3 bg-[#BC13FE]/10 border border-[#BC13FE]/30 rounded-xl">
                <p className="text-lg font-black text-[#BC13FE]">Analyze My Site for $79.99 →</p>
              </div>
              <Logo size="md" />
            </div>
          </div>
        ...
        {/* AD 98: The Early Adopter (1:1) */}
        <AdFrame ratio="1:1" id="ad-98-dr-early-adopter">
          <div className="w-full h-full bg-[#050508] relative overflow-hidden flex flex-col justify-center p-12 text-center">
            <div className="absolute bottom-0 left-0 w-full h-[50%] bg-[#fe3f8c]/5 rounded-full blur-[100px]" />
            <div className="relative z-10 space-y-6 flex flex-col items-center">
              <p className="text-xs font-bold text-[#fe3f8c] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                The land grab for AI Search visibility is happening <span className="text-[#fe3f8c]">right now.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed max-w-sm">
                For <span className="text-[#fe3f8c] font-black">$79.99</span>, you get the same GEO insights that top tier agencies are charging thousands for. We are keeping it accessible because we want to be the standard for the new web.
              </p>
              <p className="text-sm text-white/40 leading-relaxed max-w-sm">
                Structure your content so it becomes the &quot;Trusted Source&quot; for AI agents across the web.
              </p>
              <div className="inline-block px-6 py-3 bg-[#fe3f8c]/10 border border-[#fe3f8c]/30 rounded-xl">
                <p className="text-lg font-black text-[#fe3f8c]">Claim Your Authority for $79.99 →</p>
              </div>
              <Logo size="md" />
            </div>
          </div>
        ...
        {/* AD 99: The Invisible Traffic Leak (16:9) */}
        <AdFrame ratio="16:9" id="ad-99-dr-traffic-leak">
          <div className="w-full h-full bg-black relative overflow-hidden flex flex-col justify-center px-16 py-12">
            <div className="absolute top-0 left-0 w-[50%] h-full bg-gradient-to-r from-[#f59e0b]/10 to-transparent blur-3xl" />
            <div className="relative z-10 space-y-6 max-w-2xl">
              <p className="text-xs font-bold text-[#f59e0b] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Your Google traffic is dropping and you can&apos;t figure out why. It&apos;s not a penalty. <span className="text-[#f59e0b]">It&apos;s AI Overviews eating your clicks.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed">
                For <span className="text-[#f59e0b] font-black">$79.99</span>, Duelly.ai shows you exactly which queries AI is answering before users ever reach your site. No monthly subscription. One payment, full clarity.
              </p>
              <p className="text-sm text-white/40 leading-relaxed">
                Map every page on your site against AI citation signals. See which pages are being bypassed by ChatGPT, Perplexity, and Google AI Overviews, and get the fix instructions to reclaim that traffic.
              </p>
              <div className="inline-block px-6 py-3 bg-[#f59e0b]/10 border border-[#f59e0b]/30 rounded-xl">
                <p className="text-lg font-black text-[#f59e0b]">Find My Traffic Leaks for $79.99 →</p>
              </div>
            </div>
          </div>
        </AdFrame>

        {/* AD 100: The Agency Closer (4:3) */}
        <AdFrame ratio="4:3" id="ad-100-dr-agency-closer">
          <div className="w-full h-full bg-[#0a0a12] relative overflow-hidden flex flex-col justify-center p-12">
            <div className="absolute inset-0 bg-gradient-to-br from-[#00e5ff]/5 to-transparent" />
            <div className="relative z-10 space-y-6 max-w-lg">
              <p className="text-xs font-bold text-[#00e5ff] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Your SEO agency is still reporting on keyword rankings. Meanwhile, <span className="text-[#00e5ff]">AI engines are deciding who gets cited and who gets ignored.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed">
                Duelly.ai is <span className="text-[#00e5ff] font-black">$79.99</span>. Run the audit yourself and bring the report to your next agency call. If they can&apos;t explain your AEO and GEO scores, you have your answer.
              </p>
              <p className="text-sm text-white/40 leading-relaxed">
                Get a three-pillar audit (SEO, AEO, GEO) that scores your site the way AI search engines actually evaluate it. Platform-specific fix instructions included.
              </p>
              <div className="inline-block px-6 py-3 bg-[#00e5ff]/10 border border-[#00e5ff]/30 rounded-xl">
                <p className="text-lg font-black text-[#00e5ff]">Audit Before Your Next Agency Call → $79.99</p>
              </div>
            </div>
          </div>
        </AdFrame>

        {/* AD 101: The Competitor Spy (1:1) */}
        <AdFrame ratio="1:1" id="ad-101-dr-competitor-spy">
          <div className="w-full h-full bg-[#050508] relative overflow-hidden flex flex-col justify-center p-12 text-center">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#BC13FE08,transparent_60%)]" />
            <div className="relative z-10 space-y-6 flex flex-col items-center">
              <p className="text-xs font-bold text-[#BC13FE] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Your competitor just showed up in a ChatGPT answer. You didn&apos;t. <span className="text-[#BC13FE]">That wasn&apos;t luck.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed max-w-sm">
                <span className="text-[#BC13FE] font-black">$79.99</span> gets you a head-to-head Competitor Duel. See their SEO, AEO, and GEO scores side by side with yours. No contracts, no monthly drain on your budget.
              </p>
              <p className="text-sm text-white/40 leading-relaxed max-w-sm">
                Duelly crawls both sites, runs AI analysis on both, and delivers a gap report showing exactly what they did right and what you need to change. Backlink data from Moz included.
              </p>
              <div className="inline-block px-6 py-3 bg-[#BC13FE]/10 border border-[#BC13FE]/30 rounded-xl">
                <p className="text-lg font-black text-[#BC13FE]">Run a Competitor Duel for $79.99 →</p>
              </div>
              <Logo size="md" />
            </div>
          </div>
        ...
        {/* AD 102: The Small Business Equalizer (4:5) */}
        <AdFrame ratio="4:5" id="ad-102-dr-equalizer">
          <div className="w-full h-full bg-[#0a0a12] relative overflow-hidden flex flex-col justify-center p-10 text-center">
            <div className="absolute bottom-0 right-0 w-full h-[40%] bg-[#fe3f8c]/5 rounded-full blur-[100px]" />
            <div className="relative z-10 space-y-6 flex flex-col items-center">
              <p className="text-xs font-bold text-[#fe3f8c] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Enterprise brands have entire teams optimizing for AI search. You have a website and 30 minutes. <span className="text-[#fe3f8c]">That&apos;s enough.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed max-w-sm">
                Duelly.ai costs <span className="text-[#fe3f8c] font-black">$79.99</span>. Not $79.99 per month. One payment. 180 credits. Enough to audit your homepage, your top pages, and your biggest competitor.
              </p>
              <p className="text-sm text-white/40 leading-relaxed max-w-sm">
                Every audit includes prioritized fix instructions written for your specific platform. WordPress, Shopify, Wix, Squarespace. Copy the fix, paste it in, move on.
              </p>
              <div className="inline-block px-6 py-3 bg-[#fe3f8c]/10 border border-[#fe3f8c]/30 rounded-xl">
                <p className="text-lg font-black text-[#fe3f8c]">Level the Playing Field for $79.99 →</p>
              </div>
              <Logo size="md" />
            </div>
          </div>
        ...
        {/* AD 103: The "Free Tools" Exposé (16:9) */}
        <AdFrame ratio="16:9" id="ad-103-dr-free-tools">
          <div className="w-full h-full bg-black relative overflow-hidden flex flex-col justify-center px-16 py-12">
            <div className="absolute top-0 right-0 w-[40%] h-full bg-[radial-gradient(ellipse_at_right,#f59e0b10,transparent_70%)]" />
            <div className="relative z-10 space-y-6 max-w-2xl">
              <p className="text-xs font-bold text-[#f59e0b] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                &quot;Free SEO audit&quot; tools exist to harvest your email and sell you a $200/month subscription. <span className="text-[#f59e0b]">You know this.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed">
                Duelly.ai is <span className="text-[#f59e0b] font-black">$79.99</span> upfront. No email drip campaigns. No &quot;upgrade to see your results.&quot; You pay, you get the full audit, you own the data.
              </p>
              <p className="text-sm text-white/40 leading-relaxed">
                A real AI-powered analysis using Google Gemini. Not a checklist. An actual large language model reading your content and scoring it across SEO, AEO, and GEO. PDF report included.
              </p>
              <div className="inline-block px-6 py-3 bg-[#f59e0b]/10 border border-[#f59e0b]/30 rounded-xl">
                <p className="text-lg font-black text-[#f59e0b]">Get the Real Audit for $79.99 →</p>
              </div>
            </div>
          </div>
        </AdFrame>

        {/* AD 104: The Content Creator (4:3) */}
        <AdFrame ratio="4:3" id="ad-104-dr-content-creator">
          <div className="w-full h-full bg-[#050508] relative overflow-hidden flex flex-col justify-center p-12">
            <div className="absolute inset-0 bg-gradient-to-t from-[#00e5ff]/5 to-transparent" />
            <div className="relative z-10 space-y-6 max-w-lg">
              <p className="text-xs font-bold text-[#00e5ff] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                You spent 40 hours writing that pillar post. <span className="text-[#00e5ff]">ChatGPT doesn&apos;t know it exists.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed">
                For <span className="text-[#00e5ff] font-black">$79.99</span>, Duelly.ai tells you exactly why. Is your schema missing? Are your entities unclear? Is your content structured in a way AI can parse? You&apos;ll know in minutes.
              </p>
              <p className="text-sm text-white/40 leading-relaxed">
                Get an AEO score that measures your content&apos;s &quot;citability&quot; by AI engines. Plus specific rewrites and schema markup you can add today to start appearing in AI-generated answers.
              </p>
              <div className="inline-block px-6 py-3 bg-[#00e5ff]/10 border border-[#00e5ff]/30 rounded-xl">
                <p className="text-lg font-black text-[#00e5ff]">Make My Content Citable for $79.99 →</p>
              </div>
            </div>
          </div>
        </AdFrame>

        {/* AD 105: The Future-Proofer (1:1) */}
        <AdFrame ratio="1:1" id="ad-105-dr-future-proofer">
          <div className="w-full h-full bg-[#0a0a12] relative overflow-hidden flex flex-col justify-center p-12 text-center">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,#BC13FE05,transparent_50%)]" />
            <div className="relative z-10 space-y-6 flex flex-col items-center">
              <p className="text-xs font-bold text-[#BC13FE] uppercase tracking-[0.3em]">The Hook</p>
              <p className="text-3xl font-black text-white leading-tight">
                Google is putting AI Overviews above every organic result. Perplexity is replacing &quot;let me Google that.&quot; <span className="text-[#BC13FE]">The post-click era is not coming. It is here.</span>
              </p>
              <p className="text-base text-white/60 leading-relaxed max-w-sm">
                Duelly.ai is <span className="text-[#BC13FE] font-black">$79.99</span> because we believe every business deserves to know where they stand in AI search. Not just the ones who can afford enterprise contracts.
              </p>
              <p className="text-sm text-white/40 leading-relaxed max-w-sm">
                Audit your entire site across three dimensions: traditional SEO health, Answer Engine readiness (AEO), and Generative Engine visibility (GEO). Walk away with a prioritized action plan and downloadable PDF.
              </p>
              <div className="inline-block px-6 py-3 bg-[#BC13FE]/10 border border-[#BC13FE]/30 rounded-xl">
                <p className="text-lg font-black text-[#BC13FE]">Future-Proof My Site for $79.99 →</p>
              </div>
              <Logo size="md" />
            </div>
          </div>
