...
function LoginForm() {
  ...
  const redirect = searchParams.get('redirect') || '/ai-test'
  // Show any error passed back from the OAuth callback (?error=...)
...
export default function LoginPage() {
  return (
    <div className="min-h-screen h-screen overflow-y-auto bg-background flex items-center justify-center p-4">
