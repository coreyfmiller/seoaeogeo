...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/blog`, lastModified: '2026-05-10', changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/blog/backlink-strategy-guide`, lastModified: '2026-05-10', changeFrequency: 'monthly', priority: 0.8 },
