        ...
        <PageShell apiStatus={apiStatus} hideSearch>
            <main className="flex-1 overflow-y-auto bg-[#0a0a0f]">
                <div className="max-w-7xl mx-auto px-3 sm:px-6 pt-4 sm:pt-6 pb-12">
                    ...
                    <CreditConfirmDialog open={creditDialogOpen} onConfirm={handleConfirmBattle} onCancel={() => setCreditDialogOpen(false)} creditCost={10} scanType="Competitor Duel" costBreakdown="10 credits per competitive intelligence duel (2 sites analyzed + backlink profiles)" />
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            {blA && (
                                <div className="rounded-2xl border border-[#22c55e]/20 bg-[#22c55e]/[0.02] backdrop-blur-xl p-5">
                                    ...
                                    <a href="/blog/backlink-strategy-guide" className="block mt-4 rounded-lg border border-green-500/30 bg-green-500/[0.05] p-4 hover:bg-green-500/[0.08] transition-colors">
