...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  ...
  {
    id: 'metadata-quality',
    term: 'Metadata Quality',
    category: 'seo',
    shortDesc: 'How well-optimized your title tags and meta descriptions are across all pages.',
    fullDesc: 'Metadata quality in the Domain Health context measures how consistently and effectively your title tags and meta descriptions are implemented across your entire site. It checks for unique titles on every page (no duplicates), proper length (50-60 characters for titles, 150-160 for descriptions), keyword placement, and whether descriptions accurately summarize page content. Missing or duplicate metadata is one of the most common sitewide SEO issues.',
    whyItMatters: 'Your title tag is the single strongest on-page ranking signal — it tells Google exactly what each page is about. Pages with optimized metadata get 20-30% more clicks than pages with missing or generic metadata. Duplicate titles confuse search engines about which page to rank, and missing descriptions mean Google auto-generates a snippet that may not represent your page well.',
    tips: [
      'Every page needs a unique title tag with the primary keyword near the start.',
      'Keep titles between 50-60 characters to avoid truncation in search results.',
      'Write compelling meta descriptions (150-160 chars) that include a call to action.',
      'Never duplicate titles or descriptions across pages — each page should be unique.',
      'Include your brand name at the end of titles: "Page Topic | Brand Name".',
    ],
    benchmarks: { good: 'All pages have unique, keyword-optimized titles and descriptions within length limits', average: 'Most pages have metadata but some duplicates or missing descriptions', poor: 'Many pages missing titles/descriptions or using duplicate metadata' },
  },
  {
    id: 'technical-health',
    term: 'Technical Health',
    category: 'technical',
    shortDesc: 'How well your site performs on speed, security, and Core Web Vitals — the technical foundation of SEO.',
    fullDesc: 'Technical health measures the infrastructure quality of your website: page load speed (response time), HTTPS security, Core Web Vitals (LCP, FID, CLS), server reliability, and proper HTTP status codes. These are the signals Google uses to evaluate whether your site provides a good user experience. A technically healthy site loads fast, is secure, and doesn\'t break or shift layout while loading.',
    whyItMatters: 'Google has confirmed that page speed and Core Web Vitals are ranking factors. Sites that load in under 2.5 seconds have a 9% bounce rate, while sites over 5 seconds see 38% bounce rates. HTTPS is a baseline requirement — non-HTTPS sites are flagged as "Not Secure" in browsers and penalized in rankings. Technical issues are often invisible to site owners but directly impact both rankings and user experience.',
    tips: [
      'Aim for response times under 500ms and total page load under 2.5 seconds.',
      'Ensure HTTPS is enabled on all pages — no mixed content warnings.',
      'Compress images to WebP format and keep them under 100KB each.',
      'Enable browser caching and use a CDN for static assets.',
      'Monitor Core Web Vitals in Google Search Console regularly.',
    ],
    benchmarks: { good: 'Sub-500ms response, HTTPS, all Core Web Vitals passing', average: 'Moderate speed (500ms-1s), HTTPS enabled, some CWV issues', poor: 'Slow response (>1s), no HTTPS, or failing Core Web Vitals' },
  },
  {
    id: 'architecture-health',
    term: 'Architecture Health',
    category: 'seo',
    shortDesc: 'How well your site is structured — internal linking, heading hierarchy, semantic HTML, and navigation.',
    fullDesc: 'Architecture health evaluates the structural organization of your website: internal linking patterns (are pages well-connected?), heading hierarchy (proper H1 > H2 > H3 nesting), semantic HTML usage (article, nav, main, aside tags), navigation depth (how many clicks to reach any page), and URL structure. Good architecture helps both search engines and users find content efficiently.',
    whyItMatters: 'Search engines crawl your site by following links. Poor internal linking means some pages may never be discovered or indexed. A flat, well-linked architecture distributes "link equity" across your site, helping all pages rank better. Proper heading hierarchy helps AI and search engines understand content structure and topic relationships. Sites with strong architecture consistently outperform sites with the same content but poor structure.',
    tips: [
      ...
      'Maintain proper heading hierarchy: one H1 per page, H2s for sections, H3s for subsections.',
      'Use semantic HTML elements (article, nav, main, aside) instead of generic divs.',
      'Create a logical URL structure that mirrors your site hierarchy.',
    ],
    benchmarks: { good: 'Strong internal linking, proper heading hierarchy, semantic HTML throughout', average: 'Basic linking structure, some heading issues, minimal semantic HTML', poor: 'Orphaned pages, broken heading hierarchy, no semantic HTML' },
  },
  {
