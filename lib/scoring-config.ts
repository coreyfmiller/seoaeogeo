...
export const PENALTY_DICTIONARY = {
    seo: {
        missingTitle: { points: 20, description: "Missing <title> tag, a critical ranking factor." },
        ...
        lowWordCount: { points: 25, description: "Thin content (under 300 words). Highly unlikely to rank for competitive terms." },
        ...
        poorReadability: { points: 10, description: "Semantic Warning: Content is unnecessarily complex or unreadable for a general audience." }
    },
    aeo: {
        noSchema: { points: 30, description: "Critical: No LD+JSON schema detected. Answer engines rely heavily on schema for extraction." },
    ...
    geo: {
        ...
        promotionalTone: { points: 20, description: "Semantic Warning: Tone is highly promotional/salesy. LLMs prefer and cite factual, objective data." },
        ...
        heavyFirstPersonUsage: { points: 10, description: "Semantic Warning: Heavy use of first-person pronouns (We/Our/I) introduces subjective bias." },
        unsubstantiatedClaims: { points: 15, description: "Semantic Warning: Entity makes claims without providing external/internal substantiating references." }
    }
};
