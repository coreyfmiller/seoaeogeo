...
export const PENALTY_DICTIONARY = {
    seo: {
        ...
        missingMain: { points: 5, description: "Missing <main> semantic tag on content-heavy page. Improves accessibility and helps crawlers identify primary content." },
        ...
        noExternalLinks: { points: 3, description: "No outbound links to authoritative sources on content-heavy page. External references can enhance trust signals." },
    ...
    geo: {
        ...
        noSocialProofLinks: { points: 5, description: "No external social proof links (LinkedIn, Twitter) found. Recommended for business sites to validate entity." },
