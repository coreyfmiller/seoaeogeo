...
` : ''}
  ...
  try {
    // Single call mode — used by deep scan (10 pages) where multi-page averaging provides stability
    ...
    // Default: Run 2 parallel Gemini calls and average semanticFlags for scoring stability
